...
```{r}
toolik_chlorophyll_plot <- ggplot(data = toolik_chlorophyll, aes(x = depth, y = active_chl_a_ug_l)) +
  geom_point(aes(color = active_chl_a_ug_l), show.legend = FALSE) +
  scale_color_gradient(low = "blue", high = "orange") +
  theme_minimal() +
  labs(title = "Toolik Station Chlorophyll",
       x = "Depth",
       y = "Active Chlorophyll a (ug/l)")
